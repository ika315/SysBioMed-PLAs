...
# UMAP
png(filename = "plots/seurat_downgrade/04_Vision_B_UMAP_seurat_annotation.png", width = 900, height = 700)
...
# Violin Plot
png(filename = "plots/seurat_downgrade/04_Vision_B_Violin_seurat_annotation.png", width = 1000, height = 600)
...
png(filename = "plots/seurat_downgrade/04_Vision_B_PrecisionRecall_Curve.png", width = 800, height = 700)
...
png(filename = "plots/seurat_downgrade/04_Vision_B_ZScore_Distribution.png", width = 1500, height = 800)
...
png(filename = "plots/seurat_downgrade/04_Vision_B_ZScore_3Groups.png", width = 800, height = 600)
