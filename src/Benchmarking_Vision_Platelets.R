...
tryCatch({
  ...
  for (ann in annotation_levels) {
    ...
    png(
      filename = file.path("plots", "benchmarking_vision", paste0("04_Reference_UMAP_Platelet_", ann, ".png")),
      width = 1200,
      height = 800
    )
  ...
  for (ann in annotation_levels) {
    ...
    ## ---- UMAP (VISION SCORE) ----
    png(
      filename = file.path("plots", "benchmarking_vision", paste0("Vision_Platelet_UMAP_", ann, ".png")),
    ...
    print(
      FeaturePlot(
        ...
        labs(
          title = "VISION Score (Platelet) auf UMAP",
    ...
    ## ---- VIOLIN ----
    png(
      filename = file.path("plots", "benchmarking_vision", paste0("Vision_Platelet_Violin_", ann, ".png")),
  ...
  png("plots/benchmarking_vision/Vision_Platelet_PrecisionRecall_Curve.png", 800, 700)
  print(p_pr)
  dev.off()
  ...
  png("plots/benchmarking_vision/Vision_Platelet_ZScore_Distribution.png", 1500, 800)
  print(p_z)
  dev.off()
  ...
  png("plots/benchmarking_vision/Vision_Platelet_ZScore_3Groups.png", 800, 600)
  print(p_z3)
  dev.off()
  ...
  png("plots/benchmarking_vision/04_Bench_ErrorTypes_Platelet.png", 900, 650)
  print(p_error)
  dev.off()
  
  png("plots/benchmarking_vision/04_Vision_Bench_ErrorTypes_Platelet.png", 900, 650)
  print(p_error)
  dev.off()
  ...
  ggsave(
    "plots/benchmarking_vision/04_Vision_ZScore_Platelet_Facetted_TP_FP_FN_TN.png",
    faceted_z, width = 10, height = 6, dpi = 300
  )
  
  ggsave(
    "plots/benchmarking_vision/04_Vision_Raw_Platelet_Facetted_TP_FP_FN_TN.png",
