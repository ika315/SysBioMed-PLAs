...
png(filename = "plots/AUCell_Platelets_UMAP_Raw.png", width = 900, height = 700)

p_umap_raw <- FeaturePlot(pbmc, features = "AUCell_Raw", reduction = "umap", 
                         label = TRUE, repel = TRUE, raster = TRUE) +
    scale_colour_viridis_c(option = "magma") +
    labs(title = "AUCell Score (Platelets) auf UMAP", color = "AUCell-Score") +
    theme_minimal()
dev.off()

# --- Violin: AUCell Raw Scores ---
png(filename = "plots/AUCell_Platelets_Violin_l2.png", width = 1000, height = 600)
...
png(filename = "plots/AUCell_Platelets_Error_UMAP.png", width = 1000, height = 800)
...
ggsave(filename = "plots/AUCell_ZScore_Facetted_Errors_Platelets.png", 
...
ggsave(filename = "plots/AUCell_Raw_Facetted_Errors_Platelets.png", 
...
png(filename = "plots/AUCell_Platelets_ROC.png", width = 700, height = 700)
...
png(filename = "plots/AUCell_Platelets_PR_Optimized.png", width = 800, height = 700)
...
png(filename = "plots/AUCell_Platelets_ZScore_Distribution.png", width = 1500, height = 800)
